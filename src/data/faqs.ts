...
export const faqItems: FaqItem[] = [
  ...
  {
    question: "É possível integrar dados de planilhas?",
    answer:
      "Sim. Planilhas podem ser usadas como fonte de dados, especialmente em projetos iniciais ou áreas que ainda não possuem sistema estruturado.",
  },
  {
    question: "Os dashboards são personalizados?",
    answer:
      "Sim. As visões são criadas conforme os objetivos, indicadores, regras de negócio e rotina de acompanhamento de cada empresa.",
  },
  {
    question: "Posso acessar pelo celular?",
    answer:
      "Os dashboards podem ser preparados para acesso em computador, tablet e celular, respeitando o nível de detalhe adequado para cada tela.",
  },
  {
    question: "Como os dados são atualizados?",
    answer:
      "A atualização depende das fontes disponíveis e da estratégia definida no projeto. Ela pode ocorrer por integração, agendamento, importação ou fluxo automatizado.",
  },
  {
    question: "É possível controlar o acesso por usuário?",
    answer:
  ...
  {
    question: "É possível começar por apenas uma área?",
    answer:
      "Sim. Muitas empresas começam por comercial, financeiro, estoque ou diretoria e evoluem para outras áreas conforme ganham maturidade.",
  },
  {
    question: "O projeto pode evoluir depois da implantação?",
    answer:
      "Sim. Novas fontes de dados, indicadores e dashboards podem ser incluídos conforme surgem novas necessidades de gestão.",
  },
  {
